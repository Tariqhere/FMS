            ...
            <div class="card-body">
              ...
              <div class="page-table-header mb-4">
                <div class="row align-items-center">
                  <div class="col">
                    <h3 class="font-weight-bold">User Index</h3>
                  </div>
                  <div class="col-auto text-end">
                    <a href="{{ route('user.create') }}" class="btn btn-primary btn-sm rounded-pill" style="font-size: 8px;">
                ...
                <table class="table table-striped table-hover custom-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="{{ asset($model->image) }}" alt="" style="width: 40px; height:40px;"></td>
                      <td>{{ $model->cnic ?? 'NA' }}</td>
                      <td>{{ $model->office->title ?? 'NA' }}</td>
                      <td>{{ $model->department->name ?? 'NA' }}</td>
